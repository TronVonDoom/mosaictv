...
| [Connecting Players](clients.md) | Jellyfin, Emby, Plex (via Threadfin), VLC, and friends |
| [Hardware Acceleration](hardware-acceleration.md) | CPU vs NVIDIA GPU encoding, setup per platform, encoding profiles |
...
- Per-channel stream: `http://YOUR-SERVER:8688/iptv/channel/<number>.ts`
