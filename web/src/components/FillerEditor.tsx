  ...
  return (
    <div className="rounded border border-indigo-500/30 bg-indigo-500/5 p-3 space-y-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
        ...
        <label className="flex flex-col gap-1 text-xs">
          <span className="text-ink-muted">Visual</span>
        ...
        {draft.style === 'custom' && (
          <label className="flex flex-col gap-1 text-xs">
            <span className="text-ink-muted">Clip</span>
      ...
      <div className="flex justify-end gap-2">
        <button onClick={onCancel} className="rounded-lg border border-edge-strong hover:border-ink-faint px-3 py-1 text-sm">Cancel</button>
